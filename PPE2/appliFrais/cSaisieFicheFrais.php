...
?>
      <p class="label label-success">Les modifications de la fiche de frais ont bien été enregistrées</p>        
<?php
      }   
  }
      ?>            
      ...
      <div class="form-group" align="center">
      <p>
        <input class="btn btn-success" id="ok" type="submit" value="Valider"
...
<?php          
          ...
          ?>
              <tr>
                ...
                <td><a class="btn btn-danger" href="?etape=validerSuppressionLigneHF&amp;idLigneHF=<?php echo $lgEltHorsForfait["id"]; ?>"
...
?>
      ...
      <div class="form-group" align="center">
          ...
          <fieldset>
            ...
            <p>
              ...
              <input type="text" id="txtDateHF" name="txtDateHF"
            ...
            <p>
              ...
              <input type="text" id="txtMontantHF" name="txtMontantHF"
      ...
      <div class="form-group" align="center">
      <p>
        <input class="btn btn-success" id="ajouter" type="submit" value="Ajouter"
               title="Ajouter la nouvelle ligne hors forfait" />
        <input class="btn btn-danger" id="effacer" type="reset" value="Effacer" />
      </p> 
      </div>

...
function obtenirFicheFraisValide($idCnx) {
...
//MODIFIER LIGNE FRAIS FORFAIT 4 :

function obtenirReqModifierFicheForfaitETP($quantite, $unIDVisiteur, $UnMoisVisiteur) {
    $req = "update lignefraisforfait set quantite = '" . $quantite . "' where idVisiteur = '" . $unIDVisiteur . "' and mois = '" . $UnMoisVisiteur . "' and idFraisForfait = 'ETP'";
    return $req ;
}

function obtenirReqModifierFicheForfaitKM($quantite, $unIDVisiteur, $UnMoisVisiteur) {
    $req = "update lignefraisforfait set quantite = '" . $quantite . "' where idVisiteur = '" . $unIDVisiteur . "' and mois = '" . $UnMoisVisiteur . "' and idFraisForfait = 'KM'";
    return $req ;
}

function obtenirReqModifierFicheForfaitNUI($quantite, $unIDVisiteur, $UnMoisVisiteur) {
    $req = "update lignefraisforfait set quantite = '" . $quantite . "' where idVisiteur = '" . $unIDVisiteur . "' and mois = '" . $UnMoisVisiteur . "' and idFraisForfait = 'NUI'";
    return $req ;
}

function obtenirReqModifierFicheForfaitREP($quantite, $unIDVisiteur, $UnMoisVisiteur) {
    $req = "update lignefraisforfait set quantite = '" . $quantite . "' where idVisiteur = '" . $unIDVisiteur . "' and mois = '" . $UnMoisVisiteur . "' and idFraisForfait = 'REP'";
    return $req ;
}
...
function obtenirReqVisiteurFicheFrais() {
    $req = "select distinct visiteur.nom, visiteur.prenom, visiteur.id from visiteur, lignefraisforfait where visiteur.id = lignefraisforfait.idVisiteur";
    return $req ;
}

function obtenirReqVisiteurMoisFicheFrais() {
    $req = "select distinct idVisiteur, mois FROM lignefraisforfait";
    return $req ;
}
/**
...
function modifierNbJustifFicheFrais($idCnx, $unMois, $unIdVisiteur, $unNbJustif) {
    $requete = "update FicheFrais set nbJustificatifs = '" . $unNbJustif . 
               "', dateModif = now() where idVisiteur ='" .
               $unIdVisiteur . "' and mois = '". $unMois . "'";
    mysql_query($requete, $idCnx);
} 

function modifierMontantValide($idCnx, $unMois, $unIdVisiteur, $leMontantValide) {
    $requete = "update FicheFrais set montantValide = '" . $leMontantValide . 
               "', dateModif = now() where idVisiteur ='" .
               $unIdVisiteur . "' and mois = '". $unMois . "'";
    mysql_query($requete, $idCnx);
} 
